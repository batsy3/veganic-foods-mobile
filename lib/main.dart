...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Details(category: 1, description: 'dog food', image: 'assets/images/mgg-vitchakorn-zXNC_lBBVGE-unsplash.jpg', name: 'rice', price: '10.00', quantity: 0, product_id: 1,),
      // routes: {
